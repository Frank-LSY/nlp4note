...
function read_dir(){
    ...
    do
        ...
        then
            ...
            python3.5 /data02/shuyu/cli-BERT/bert/extract_features.py \
				--input_file="$1/$file" \
...
dir_in="/data/shuyu/classified_txt/NOTES-DISCHARGE_SUMMARY/21"
dir_out="/data/shuyu/bert_embedding/NOTES-DISCHARGE_SUMMARY"
